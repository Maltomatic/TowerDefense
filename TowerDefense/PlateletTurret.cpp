...
PlateletTurret::PlateletTurret(float x, float y) :
	Turret("play/turret-2.png", x, y, Price, 0.7, 12, 35) {
...
void PlateletTurret::CreateBullet() {
	...
	Engine::Point flash = Position + normalized * 36 - normal * 6;
	getPlayScene()->EffectGroup->AddNewObject(new ShootEffect(flash.x, flash.y));
